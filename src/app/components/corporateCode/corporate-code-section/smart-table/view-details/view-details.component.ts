...
export class ViewDetailsComponent implements OnInit {
  ...
  onClick($event) {
    ...
    this.branchStatusService.corporateCodeData = this.rowData;
    this.router.navigate([`${parentParam.id}/corporate-code/update-corporateCode/${this.rowData.corporateCode}`], {queryParams: { mode: 'view-details' }, queryParamsHandling: 'merge'});
  }
